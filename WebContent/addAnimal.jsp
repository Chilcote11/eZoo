	...
	%>
		...
		<form action="addAnimal" method="post" class="form-horizontal">
		  ...
		  <div class="form-group">
  		  ...
  		  <div class="form-group">
		    <label for="feedingScheduleID" class="col-sm-4 control-label">FeedingScheduleID</label>
		    <div class="col-sm-4">
		      <input type="number" class="form-control" id="feedingScheduleID" name="feedingScheduleID" placeholder="FeedingScheduleID"/>
		    </div>
		  </div>
		  <div class="form-group">
